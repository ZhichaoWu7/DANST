...
def main():
    ...
    if opt['target_type'] == "simulated":
        ...
        # final_preds_target1 = model_da.lpa_multilabel(max_iter=100, alpha=0.99) 
        # final_preds_target1.to_csv(os.path.join(opt['SaveResultsDir'], "target_predicted_fraction1.csv"))
